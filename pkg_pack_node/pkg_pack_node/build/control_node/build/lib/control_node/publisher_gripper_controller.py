...
class PublisherGripper(Node):
    def __init__(self):
        super().__init__("gripper_controller")
        # Declare all parameters
        self.declare_parameter("controller_name", "gripper_controller")
...
def main(args=None):
    ...
    publisher_gripper = PublisherGripper()

    rclpy.spin(publisher_gripper)
    publisher_gripper.destroy_node()
    rclpy.shutdown()
